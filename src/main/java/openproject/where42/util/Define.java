...
public class Define {
    ...
    public static final ArrayList<String> WHERE42IMG = new ArrayList<>(Arrays.asList("img/moon.jpg", "img/sojoo.jpg", "img/hyunjcho.png", "img/heeskim.jpeg"));
    public static final ArrayList<String> WHERE42MSG = new ArrayList<>(Arrays.asList("TO THE MOON", "팀 어디있니의 귀요미 입니다", "너 내 동료가 돼라!!", "블랙홀 D-3"));
