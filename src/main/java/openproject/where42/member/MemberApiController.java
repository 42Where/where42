...
//        List<GroupMemberInfo> groupMemberList = groupMemberService.getMyGroupMemberInfo(memberId); // 해당 오너의 기본 그룹에 속한 친구들 전부 반환.. friendList.. 하고픔..

//        return new ResponseMemberInfo(memberInfo, groupList, groupMemberList);
        return null;
    }
...
//        public ResponseMemberInfo(MemberInfo memberInfo, List<GroupInfo> groupInfo, List<GroupMember> groupMemberList) {
