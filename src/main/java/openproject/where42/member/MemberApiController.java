...
public class MemberApiController {
    ...
    public ResponseMemberInfo memberInformation(@PathVariable ("memberId") Long memberId) { // 두번째 로그인 부터는 이거
        ...
        List<GroupFriendInfo> groupFriendsList = memberService.findAllFriendsInfo(memberId); // 해당 오너의 기본 그룹에 속한 친구들 정보 DTO로
    ...
    public ResponseEntity updateLocate(@PathVariable("memberId") Long memberId, @RequestBody String token, @RequestBody Locate locate) { // token이 필요하다.. 어디서.. 누가 줘야 할까.. ㅠ 우리 쿠키로 주면 젤 좋음 ㅠ
