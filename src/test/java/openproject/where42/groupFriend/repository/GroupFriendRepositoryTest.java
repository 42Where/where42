...
//        save();
//        List<String> groupsList = groupFriendRepository.notIncludeGroupByFriend(members.get("jaebae"), groupMembers.get("hyunjcho"));
...
//        save();
//        List<String> friendList = groupFriendRepository.notIncludeFriendByGroup(members.get("jaebae"), groups.get("where42"));
...
//        save();
//        groupFriendRepository.deleteFriendsGroupByName(members.get("jaebae"), "hyunjcho");
//    }
//}